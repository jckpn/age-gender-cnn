...
eye_y = 0.45*dest_h          # Y coord of both eyes in final image
eye_x = 0.35*dest_w         # X coord of left eye in final image
...
if __name__ == '__main__':
    ...
    input_img = cv.filter2D(src=input_img, ddepth=-1, kernel=kernel)
